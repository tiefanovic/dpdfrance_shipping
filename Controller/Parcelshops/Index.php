...
use DPDFrance\Shipping\Helper\Services\DPDPickupService;
...
class Index extends \Magento\Framework\App\Action\Action
{
	...
	public function execute()
	{
		...
		$resultData["gmapsIcon"] = $this->assetRepo->getUrlWithParams('DPDFrance_Shipping::images/icon_parcelshop.png', $params);
		$resultData["gmapsIconShadow"] = $this->assetRepo->getUrlWithParams('DPDFrance_Shipping::images/icon_parcelshop_shadow.png', $params);
	...
	{
		$image = $this->assetRepo->getUrlWithParams('DPDFrance_Shipping::images/dpd_parcelshop_logo.png', array('_secure' => $this->getRequest()->isSecure()));
		$routeIcon = $this->assetRepo->getUrlWithParams('DPDFrance_Shipping::images/icon_route.png', array('_secure' => $this->getRequest()->isSecure()));
