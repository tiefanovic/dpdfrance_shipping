 ...
 *
 */
namespace DPDFrance\Shipping\Controller\Adminhtml\Tablerate;
...
class Export  extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    ...
    public function execute()
    {
        ...
        /** @var $gridBlock \DPDFrance\Shipping\Block\Adminhtml\Tablerate\Grid */
        $gridBlock = $this->_view->getLayout()->createBlock(
            'DPDFrance\Shipping\Block\Adminhtml\Tablerate\Grid'
        );
